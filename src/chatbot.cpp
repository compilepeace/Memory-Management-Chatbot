...
ChatBot::ChatBot(const ChatBot &source){             // copy constructor
    std::cout << "COPY constructor: " << &source << "to " << this << "\n";
...
ChatBot &ChatBot::operator=(const ChatBot &source){  // copy assignment operator
    std::cout << "COPY assignment operator: " << &source << "to " << this << "\n";
    if (this == &source)
        return *this;
   // if (_image != NULL)
        delete _image;
...
ChatBot::ChatBot(ChatBot &&source){               // move constructor 
    std::cout << "MOVE constructor: " << &source << "to " << this << "\n";
    _chatLogic = source._chatLogic;
    _rootNode = source._rootNode;
...
ChatBot& ChatBot::operator=(ChatBot &&source) {       // move asssignment operator
    std::cout << "MOVE assignment operator: " << &source << "to " << this << "\n";
    if (this == &source)
        return *this;
    //if (_image != NULL)
        delete _image;

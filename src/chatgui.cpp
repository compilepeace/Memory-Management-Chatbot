...
{
    std::cout << "ChatBotFrame constructed\n";
...
{
    std::cout << "ChatBotPanelDialog constructed\n";
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    std::cout << "ChatBotPanelDialog destructed\n";
    //delete _chatLogic;
...
{
    std::cout << "ChatBotPanelDialogItem constructed\n";
